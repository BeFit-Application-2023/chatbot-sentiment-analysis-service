...
from schemas import SentimentTextSchema
...
class SentimentModel(db.Model):
    ...
    prediction = db.Column(db.Float, unique=False)

    def __init__(self, index : str, text : str, correlation_id : str, prediction : float):
        '''
    ...
    if check_response != "OK":
        ...
        if status_code != 200:
            ...
            if TASK_EXECUTOR.available_process_num() > 0:
                ...
                new_intent_record = SentimentModel(
                    index,
                    result["text"],
